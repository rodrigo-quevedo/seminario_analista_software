...
export default class UserNotAuthenticatedError extends CustomError {
    ...
    constructor(){ 
        super(`No hay un idUsuario en el request body, o no es valido (debe ser un string de 24 caracteres hex). El idUsuairo es necesario para acceder a esta ruta.`);
